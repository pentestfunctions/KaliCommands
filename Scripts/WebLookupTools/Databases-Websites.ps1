...
if ($braveInstalled) {
    ...
    Start-Process "wsl" -ArgumentList "brave-browser 'https://search.0t.rocks/' 'https://leak-lookup.com/' 'https://breachdirectory.com/search' 'https://www.dehashed.com/'" -WindowStyle Hidden
} else {
